          ...
          {highlightList.map((hl, i) => {
            ...
            return (
              <motion.div
                ...
                whileHover={{ y: -8 }}
                className="glass-card p-6 rounded-2xl flex flex-col justify-between shadow-sm relative overflow-hidden group"
              >
                ...
                <div>
                  <div className="inline-flex items-center justify-center p-3 rounded-xl bg-navy-900 text-gold-500 mb-6 group-hover:bg-gold-500 group-hover:text-navy-900 transition-all duration-300">
                ...
                <div className="border-t border-navy-900/5 dark:border-gold-500/15 pt-4">
                  <span className="block text-2xl font-extrabold text-navy-900 dark:text-gold-500 tracking-tight">
                    {hl.stat}
                  </span>
                  <span className="block text-xs font-semibold text-slate-400 dark:text-slate-400 uppercase tracking-widest mt-1">
                    {hl.statDesc}
                  </span>
                </div>
              </motion.div>
