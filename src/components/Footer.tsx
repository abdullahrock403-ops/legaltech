        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-12 pb-16 border-b border-slate-800">
          ...
          <div className="lg:col-span-2 space-y-6">
            ...
            <div className="flex space-x-4 rtl:space-x-reverse pt-2">
              ...
              <a href="#" aria-label="Twitter" className="w-10 h-10 rounded-full bg-slate-800 flex items-center justify-center text-slate-400 hover:text-gold-500 hover:bg-slate-700 transition-colors">
                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-sm text-slate-400">
              ...
              <li><Link href="/contact" className="hover:text-gold-500 transition-colors">{t("nav_contact")}</Link></li>
            </ul>
          </div>
